        ...
        <main class="pt-20">
            ...
            <section class="lg:p-20 lg:mx-12 mx-2">
                ...
                <div class="lg:grid grid-cols-2 gap-9 mt-5 relative">
                    ...
                    <button v-if="batch.data.images?.length > 5" class="absolute bottom-0 right-16 rounded-full bg-white border border-[#D9D9D9] p-2">Mostrar todas las fotos<i class="fa-solid fa-photo-film ml-2 text-xs"></i></button>
                </div>
                    ...
                    <div class="col-span-3">
                        ...
                        <div class="my-7">
                            ...
                            <div class="flex flex-wrap items-center border-b border-[#D9D9D9] pb-7 space-x-3 pl-4">
                                ...
                                <!-- Vista previa -->
                                <a :href="batch.data.planos[0]?.original_url" target="_blank" class="rounded-md border border-[#D9D9D9] flex items-center px-2 py-1 cursor-pointer">
