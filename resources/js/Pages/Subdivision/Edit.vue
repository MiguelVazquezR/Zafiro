<template>
    <AppLayout title="Editar fraccionamiento">
        <div class="lg:w-[80%] mx-auto rounded-md lg:border border-secondary p-5">
            <h1 class="font-bold text-lg text-center lg:text-left">Editar fraccionamiento <span class="text-primary">"{{
                subdivision.name }}"</span></h1>
            <div class="lg:grid grid-cols-3 space-x-3 mt-3">
                <div>
                    <p class="text-xs text-red-600">Si vas a cambiar o agregar nuevas imágenes es necesario ponerlas todas
                        de nuevo ya que se eliminarán</p>
                    <InputFilePreview v-show="currentImage == 1" :imageUrl="subdivision.media[0]?.original_url"
                        @cleared="form.cleared_cover1 = true" @imagen="this.form.image_cover1 = $event;" />
                    <InputFilePreview v-show="currentImage == 2" :imageUrl="subdivision.media[1]?.original_url"
                        @cleared="form.cleared_cover2 = true" @imagen="this.form.image_cover2 = $event;" />
                    <InputFilePreview v-show="currentImage == 3" :imageUrl="subdivision.media[2]?.original_url"
                        @cleared="form.cleared_cover3 = true" @imagen="this.form.image_cover3 = $event;" />
                    <InputFilePreview v-show="currentImage == 4" :imageUrl="subdivision.media[3]?.original_url"
                        @cleared="form.cleared_cover4 = true" @imagen="this.form.image_cover4 = $event;" />
                    <InputFilePreview v-show="currentImage == 5" :imageUrl="subdivision.media[4]?.original_url"
                        @cleared="form.cleared_cover5 = true" @imagen="this.form.image_cover5 = $event;" />
                    <InputFilePreview v-show="currentImage == 6" :imageUrl="subdivision.media[5]?.original_url"
                        @cleared="form.cleared_cover6 = true" @imagen="this.form.image_cover6 = $event;" />
                    <InputFilePreview v-show="currentImage == 7" :imageUrl="subdivision.media[6]?.original_url"
                        @cleared="form.cleared_cover7 = true" @imagen="this.form.image_cover7 = $event;" />
                    <InputFilePreview v-show="currentImage == 8" :imageUrl="subdivision.media[7]?.original_url"
                        @cleared="form.cleared_cover8 = true" @imagen="this.form.image_cover8 = $event;" />
                ...
                <div class="col-span-2">
                    <div class="mt-3">
                        ...
                        <el-input v-model="form.name" placeholder="Escribe el nombre del fraccionamiento" :maxlength="100"
                            clearable />
                    ...
                    <div class="mt-3">
                        ...
                        <el-input v-model="form.address" :autosize="{ minRows: 3, maxRows: 5 }" type="textarea"
                    ...
                    <div class="mt-3">
                        ...
                        <el-input v-model="form.description" :autosize="{ minRows: 3, maxRows: 5 }" type="textarea"
                            placeholder="Escribe una breve descripción del evento" :maxlength="800" show-word-limit
                            clearable />
                        <InputError :message="form.errors.description" />
                    </div>
